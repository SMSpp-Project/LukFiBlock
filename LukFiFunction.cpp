/*--------------------------------------------------------------------------*/
/*------------------------ File LukFiFunction.cpp ---------------------------*/
/*--------------------------------------------------------------------------*/
/** @file
 * Implementation of the LukFiFunction class, which is derived from
 * a C05Function.
 *
 * \version 0.01
 *
...
LukFiFunction::dblVR2 A12 = { { 0 , 0 , 0 , 0 , 0 } , { 2 , 1 , 1 , 1 , 3 } ,
                          { 1 , 2 , 1 , 1 , 2 } , { 1 , 4 , 1 , 2 , 2 } ,
			  { 3 , 2 , 1 , 0 , 1 } , { 0 , 2 , 1 , 0 , 1 } ,
			  { 1 , 1 , 1 , 1 , 1 } , { 1 , 0 , 1 , 2 , 1 } ,
			  { 0 , 0 , 2 , 1 , 0 } , { 1 , 1 , 2 , 0 , 0 } };
...
LukFiFunction::dblVR1 b12 = { 1 , 5 , 10 , 2 , 4 , 3 , 1.7 , 2.5 , 6 , 3.5 };

// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

// vector dblVR2 of size [10,5]
LukFiFunction::dblVR2 A13 = { {-16 , 2 , 0 , 1 , 0} , { 0 , -2 , 0 , 4 , 2} ,
 {-3.5 , 0 , 2 , 0 , 0} , {0 , -2 , 0 , -4 , -1} , {0 , -9 , -2 , 1 , -2.8} ,
 {2 , 0 , -4 , 0 , 0} , {-1 , -1 , -1 , -1 , -1} , {-1 , -2 , -3 , -2 , -1} ,
 {1 , 2, 3 , 4 , 5} , {1 , 1 , 1 , 1 , 1} };
// vector dblVR1 of size [10]
LukFiFunction::dblVR1 b13 = { -40 , -2 , -0.25 , -4 , -4 , -1 , -40 , -60 , 5 , 1};
// vector dblVR2 of size [5,5]
LukFiFunction::dblVR2 C13 = { {30 , -20 , -10 , 32 , -10} , {-20 , 39, -6 , -31 ,
 32 } , {-10 , -6 , 10 , -6 , -10} , {32 , -31 , -6 , 39 , -20} ,
 {-10 , 32 , -10 , -20 , 30} };
// vector dblVR1 of size [5]
LukFiFunction::dblVR1 d13 = { 4 , 8 , 10 , 6 , 2 };
// vector dblVR1 of size [5]
LukFiFunction::dblVR1 e13 = { -15 , -27 , -36 , -18 , -12 };

// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

// vector dblVR2 of size [48,48]
LukFiFunction::dblVR2 A21 = {
...
LukFiFunction::dblVR1 s21 = { 22 , 53 , 64 , 15 , 66 , 37 , 16 ,23 , 67 , 18 , 52 ,
 69 , 17 , 29 , 50 , 13 , 95 , 34 , 59 , 36 , 22 , 94 , 28 , 34 , 36 , 38 ,
 55 , 77 , 45 , 34 , 32 , 58 , 30 , 88 , 74 , 59 , 93 , 54 , 89 , 30 , 79 ,
 46 , 35 , 41 , 99 , 52 , 76 , 93 };
// vector dblVR1 of size [48]
LukFiFunction::dblVR1 d21 = { 61 , 67 , 24 , 84 , 13 , 86 , 89 , 46 , 48 , 50 , 74 ,
...
const std::vector< std::string > LukFiFunction::int_pars_str =
             { "intNameF" , "intNrCmp" , "intseed" };

// define and initialize here the default int parameters
const std::vector<int> LukFiFunction::dflt_int_par =
        {    1 ,  // intNameF
             1,   // intNrCmp
			 0    // intseed
        };
...
const std::map< std::string , LukFiFunction::idx_type > LukFiFunction::int_pars_map =
            { { "intNameF"  , LukFiFunction::intNameF  } ,
		      { "intNrCmp" , LukFiFunction::intNrCmp } ,
			  { "intseed" , LukFiFunction::intseed }
			};
...
int LukFiFunction::compute( bool changedvars )
{
 FiVal = 0;      // value of Fi()
 dblVR1 FiVal_, tempL;
 ...
 case( 2 ):
  ...
  case ( 16 ):
   ...
   FiVal -= std::inner_product( s21.begin() , s21.end() , x.begin() , 0 );
   break;
  // Colville 1  - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  case ( 17 ):
   FiVal = std::inner_product( e13.begin() , e13.end() , x.begin() , 0 );
   for ( Index j = 0; j < 5; j++)
   ...
   FiVal_.resize(10);
   for ( Index i = 0; i < 10; i++ )
    FiVal_[i] = b13[i] - std::inner_product( A13[ i ].begin() , A13[ i ].end() , x.begin() , 0 );
  ...
  case ( 22 ):
   ...
   for ( Index i = 0; i < x.size() ; i++ )
	FiVal_[i] =  double(x[i]);
   FiVal = double(50) * *std::max_element( FiVal_.begin() , FiVal_.end() )
           - std::accumulate( FiVal_.begin() , FiVal_.end() , 0 );
   break;
  // MXHILB  - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  case ( 23 ):
  ...
  case ( 24 ):
   ...
   FiVal = std::accumulate( FiVal_.begin() , FiVal_.end() , 0 );
   break;
  // smooth  - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  case( 26 ):
...
void LukFiFunction::get_linearization_coefficients( FunctionValue * g ,
...
ThinVarDepInterface::Index LukFiFunction::is_active( const Variable * const var )
const
{
...
void LukFiFunction::map_active( c_Vec_p_Var & vars , Vec_Index & map ,
...
int LukFiFunction::get_int_par( const idx_type par ) const
{
 switch( par ) {
  case( intNameF ):
   return( NameF );
